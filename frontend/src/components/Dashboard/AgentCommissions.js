      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="text-right">
          ...
          <div className="text-2xl font-bold text-blue-600">
            {formatCurrency(commissions.reduce((sum, c) => sum + c.pending, 0))}
          </div>
        </div>
      </div>
          ...
          <tbody className="divide-y divide-gray-200">
            {commissions.map((commission) => (
              <tr key={commission.agent} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <div className="font-bold text-gray-900">{formatCurrency(commission.totalSales)}</div>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                  <div className="font-bold text-yellow-600">{formatCurrency(commission.pending)}</div>
                </td>
                <td className="px-6 py-4">
                  <div className="font-bold text-green-600">{formatCurrency(commission.paid)}</div>
                </td>
